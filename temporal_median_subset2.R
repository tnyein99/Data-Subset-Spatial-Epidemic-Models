...
temporal_median<-function(sam){
  ...
  alpha_bias<-abs(alpha_t_median-alpha_100p)
  alpha_sd_bias<-abs(alpha_sd_t_median-alpha_sd_100p)
  beta_bias<-abs(beta_t_median-beta_100p)
  beta_sd_bias<-abs(beta_sd_t_median-beta_sd_100p)
...
write.csv(df_abs_biases,"/home/thethtetchan.nyein/temporal_median2_100_abs_biases.csv", row.names = FALSE)
