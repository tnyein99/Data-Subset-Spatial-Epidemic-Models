...
alpha_abs_bias<-c(rep(NA,20))
alpha_sd_abs_bias<-c(rep(NA,20))
beta_abs_bias<-c(rep(NA,20))
beta_sd_abs_bias<-c(rep(NA,20))
...
write.csv(df_abs_biases,"/home/thethtetchan.nyein/percent10_corner_100_abs_biases.csv", row.names = FALSE)
