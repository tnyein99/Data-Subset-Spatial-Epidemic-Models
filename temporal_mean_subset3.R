...
temporal_mean<-function(sam){
  ...
  mcmc_out_t1<-epimcmc(object = sir_mod0, tmin = min(sir_mod0$inftime), tmax = 5,
                       niter = 50000, sus.par.ini = 1, beta.ini = 1,
                       Sformula = NULL, pro.sus.var = 0.3, pro.beta.var = 0.1,
                       prior.sus.dist = "gamma", prior.beta.dist = "gamma",
                       prior.sus.par = alphapar2, prior.beta.par = betapar2,
  ...
  mcmc_out_t2<-epimcmc(object = sir_mod0, tmin = 6, tmax = 10,
                       niter = 50000, sus.par.ini = 1, beta.ini = 1,
                       Sformula = NULL, pro.sus.var = 0.3, pro.beta.var = 0.1,
                       prior.sus.dist = "gamma", prior.beta.dist = "gamma",
                       prior.sus.par = alphapar2, prior.beta.par = betapar2,
  ...
  mcmc_out_t3<-epimcmc(object = sir_mod0, tmin = 11, tmax = 15,
                       niter = 50000, sus.par.ini = 1, beta.ini = 1,
                       Sformula = NULL, pro.sus.var = 0.3, pro.beta.var = 0.1,
                       prior.sus.dist = "gamma", prior.beta.dist = "gamma",
                       prior.sus.par = alphapar2, prior.beta.par = betapar2,
  ...
  alpha_abs_bias<-abs(alpha_t_mean-alpha_100p)
  alpha_sd_abs_bias<-abs(alpha_sd_t_mean-alpha_sd_100p)
  beta_abs_bias<-abs(beta_t_mean-beta_100p)
  beta_sd_abs_bias<-abs(beta_sd_t_mean-beta_sd_100p)
...
write.csv(df_abs_biases,"/home/thethtetchan.nyein/temporal_mean3_100_abs_biases.csv", row.names = FALSE)
